"""Smaller/faster rerun of diag_st235_hypotheses.py: only the 3 alternative variants
(baseline already known from diag_st235_rcwa_mh.py's full-grid run), fewer wavelengths.
"""
import sys, os
import numpy as np
...
subset = wls_all[::8]   # ~5 wavelengths
...
# baseline for reference on THIS subset (for apples-to-apples with the alt variants below)
